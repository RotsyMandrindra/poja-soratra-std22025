...
public class PoeticPhraseController {
    ...
    public ResponseEntity<Map<String, String>> getPoeticPhraseUrls(@PathVariable Long id) {
        try (S3Client s3 = S3Client.create();
            ...
            PresignedGetObjectRequest originalPresignedRequest = presigner.presignGetObject(
            ...
            PresignedGetObjectRequest transformedPresignedRequest = presigner.presignGetObject(
                    GetObjectPresignRequest.builder()
                            .signatureDuration(Duration.ofMinutes(15))
                            .getObjectRequest(GetObjectRequest.builder()
                                    .bucket(BUCKET_NAME)
